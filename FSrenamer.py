...
def FSRenamerUI():
	...
	materialList = mods.modReturnMaterialPrefix(2)[1]
	materialList.sort()
	colorList = mods.modReturnMaterialPrefix(2)[0]
	colorList.sort()
	...
	window = cmds.window("FSRenamer_window", title= __title__+ ' ' +__version__, iconName='FSRenamer', width=windowSize )
	...
	cmds.frameLayout(label="Search and Replace", collapsable=True, collapse=True, bgc=frame_bgc, borderStyle="etchedIn")
	...
	cmds.frameLayout(label="Prefix and Suffix", collapsable=True, collapse=True, bgc=frame_bgc, borderStyle="etchedIn")
	cmds.separator( height=5, style='none' )
	...
	cmds.frameLayout(label="Namespace Utilities", collapsable=True, collapse=True, bgc=frame_bgc, borderStyle="etchedIn")
	cmds.separator( height=5, style='none' )
	...
	cmds.frameLayout(label="Padding", collapsable=True, collapse=False, bgc=frame_bgc, borderStyle="etchedIn")
	cmds.separator( height=5, style='none' )
	...
	cmds.frameLayout(label="Renaming Input Fields", collapsable=True, collapse=False, bgc=frame_bgc, borderStyle="etchedIn")
	cmds.separator( height=10, style='none' )
